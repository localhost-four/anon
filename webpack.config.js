...
module.exports = {
  mode: 'production',
  entry: '/anon/index.html',  // точка входа вашего приложения
  output: {
    path: path.resolve(__dirname, 'dist'),
    filename: '/anon/bundle.js', // название основного бандла
    publicPath: 'anon', // путь на GitHub Pages
  },
  module: {
    rules: [
      {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: '/anon/index.html', // файл-шаблон для генерации index.html
    }),
  ],
  devServer: {
